 ...
 *
 * This project (07) builds for `kit_pse84_eval/pse846gps2dbzc4a/m33/ns`
 * under TF-M -- CM33 Non-Secure -- so we MUST use the Non-Secure
 * alias. Writing the Secure alias 0x529a0000 from NS raises a
 * BusFault ("peripheral not accessible from current security state")
 * that escalates to HardFault. Project 06 used 0x529a0000 because it
 * ran from CM33-Secure without TF-M; the two projects deliberately
 * pin different aliases in this one line and are otherwise identical.
 *
 * The pse84.dtsi node for the NS alias:
 *   scb2: scb@429a0000 { reg = <0x429a0000 0xfd0>; ... }
 *
 ...
 */
#define APP_SCB2_BASE 0x429a0000u
