...
struct bgt60tr13c_api {
	...
	/* config(): apply a caller-owned register array (packed 32-bit SPI
	 * write commands) generated by bgt60-configurator-cli.  The array
	 * encodes an application-specific radar recipe (antennas, chirp
	 * bandwidth, IF gain, sample rate), so it lives in the app, not
	 * the driver.
	 */
